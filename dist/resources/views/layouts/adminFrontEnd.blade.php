...
<body id="app-layout">
    ...
    <div class="main-container">
            ...
            <a href="{{url('/dataTable')}}" class="btn-sidebar"><i class="fa fa-users pull-left" aria-hidden="true"></i>&nbsp;<span>Employees summary</span></a>
					{{--	<a href="{{url('/getReports')}}" class="btn-sidebar btn-one">Employee Leave summary</a> --}}
						<a href="{{url('/phm')}}" class="btn-sidebar" ><i class="fa fa-rub pull-left" aria-hidden="true"></i><span>Public Holiday Manager</span></a>
            <a href="{{url('/carryOver')}}" class="btn-sidebar" ><i class="fa fa-rub pull-left" aria-hidden="true"></i><span>Carryover leave days</span></a>
            <a href="{{url('/')}}" class="btn-sidebar" ><i class="fa fa-arrow-circle-left pull-left" aria-hidden="true"></i>&nbsp; <span> Exit Admin section </span></a>
						{{-- <a href="{{url('/add_sub')}}" class="btn-sidebar" >Reclaim leave days</a> --}}
					{{--	<a href="{{url('/staffOnLeave')}}" class="btn-sidebar" >View staff on leave</a> --}}
