...
function workingDaysExcludingHolidays(startDate, endDate) {
    ...
    {
        if( (milliHolidays[j] >= x ) && (milliHolidays[j] <= y) )
        {
   ...
   console.log("no of holidays is" + noOfHolidays);
     ...
     /**
        ...
        /**
            ...
            if( leaveType !== "Maternity")
            {
                ...
                console.log("diff returned "+ diff);
                var day = "";
...
/**
 * Code for Date picker and sidebar toggle nav
 */
function toggleNav() {
